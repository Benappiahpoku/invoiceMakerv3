            ...
            <div class="max-w-2xl mx-auto text-center space-y-6">
                ...
                <div class="space-y-2">
                    <h2 class="text-xl sm:text-2xl font-bold text-white">
                        Need to create a {{ alternateLabel }} instead?
                    </h2>
                    <p class="text-primary-100 text-sm sm:text-base">
                        Switch to our {{ alternateLabel.toLowerCase() }} generator for your business needs
                    </p>
                </div>
...
const alternateLabel = computed(() =>
    props.type === 'invoice' ? 'Receipt' : 'Invoice'
)

// Update these with your live Vercel URLs
const invoiceUrl = 'https://invoice.stratonea.com/'
const receiptUrl = 'https://receipt.stratonea.com/'
